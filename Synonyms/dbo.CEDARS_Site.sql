RAISERROR ('*** Executing SQL: "...\Synonyms\dbo.CEDARS_Site.sql"', 0, 1) WITH NOWAIT;
GO

/*================================================================================================================
Script:		dbo.CEDARS_Site.sql
...
BEGIN
	EXECUTE [dbo].[CreateSynonym] @FullyQualifiedName = N'[CEDARS].[dbo].[Site]';
END
