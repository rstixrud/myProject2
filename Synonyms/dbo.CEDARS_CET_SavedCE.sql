RAISERROR ('*** Executing SQL: "...\Synonyms\dbo.CEDARS_CET_SavedCE.sql"', 0, 1) WITH NOWAIT;
GO

/*================================================================================================================
Script:		dbo.CEDARS_CET_SavedCE.sql
...
BEGIN
	EXECUTE [dbo].[CreateSynonym] @FullyQualifiedName = N'[CEDARS_CET].[dbo].[SavedCE]';
END
