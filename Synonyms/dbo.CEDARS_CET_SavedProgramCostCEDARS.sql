RAISERROR ('*** Executing SQL: "...\Synonyms\dbo.CEDARS_CET_SavedProgramCostCEDARS.sql"', 0, 1) WITH NOWAIT;
GO

/*================================================================================================================
Script:		dbo.CEDARS_CET_SavedProgramCost.sql
...
BEGIN
	EXECUTE [dbo].[CreateSynonym] @FullyQualifiedName = N'[CEDARS_CET].[dbo].[SavedProgramCostCEDARS]';
END
