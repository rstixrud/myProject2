RAISERROR ('*** Executing SQL: "...\Synonyms\dbo.CETMGMT_InputProgramView.sql"', 0, 1) WITH NOWAIT;
GO

/*================================================================================================================
Script:		dbo.CETMGMT_InputProgramView.sql
...
BEGIN
	EXECUTE [dbo].[CreateSynonym] @FullyQualifiedName = N'[CETMGMT].[dbo].[InputProgramView]';
END
