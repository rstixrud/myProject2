RAISERROR ('*** Executing SQL: "...\Synonyms\dbo.CEDARS_ContactClaim.sql"', 0, 1) WITH NOWAIT;
GO

/*================================================================================================================
Script:		dbo.CEDARS_ContactClaim.sql
...
BEGIN
	EXECUTE [dbo].[CreateSynonym] @FullyQualifiedName = N'[CEDARS].[dbo].[ContactClaim]';
END
