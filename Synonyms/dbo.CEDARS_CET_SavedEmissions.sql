RAISERROR ('*** Executing SQL: "...\Synonyms\dbo.CEDARS_CET_SavedEmissions.sql"', 0, 1) WITH NOWAIT;
GO

/*================================================================================================================
Script:		dbo.CEDARS_CET_SavedEmissions.sql
...
BEGIN
	EXECUTE [dbo].[CreateSynonym] @FullyQualifiedName = N'[CEDARS_CET].[dbo].[SavedEmissions]';
END
