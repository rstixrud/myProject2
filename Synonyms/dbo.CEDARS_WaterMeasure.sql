RAISERROR ('*** Executing SQL: "...\Synonyms\dbo.CEDARS_WaterMeasure.sql"', 0, 1) WITH NOWAIT;
GO

/*================================================================================================================
Script:		dbo.CEDARS_WaterMeasure.sql
...
BEGIN
	EXECUTE [dbo].[CreateSynonym] @FullyQualifiedName = N'[CEDARS].[dbo].[WaterMeasure]';
END
