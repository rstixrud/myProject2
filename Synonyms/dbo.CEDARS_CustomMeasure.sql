RAISERROR ('*** Executing SQL: "...\Synonyms\dbo.CEDARS_CustomMeasure.sql"', 0, 1) WITH NOWAIT;
GO

/*================================================================================================================
Script:		dbo.CEDARS_CustomMeasure.sql
...
BEGIN
	EXECUTE [dbo].[CreateSynonym] @FullyQualifiedName = N'[CEDARS].[dbo].[CustomMeasure]';
END
