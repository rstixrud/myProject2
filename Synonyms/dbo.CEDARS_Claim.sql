RAISERROR ('*** Executing SQL: "...\Synonyms\dbo.CEDARS_Claim.sql"', 0, 1) WITH NOWAIT;
GO

/*================================================================================================================
Script:		dbo.CEDARS_Claim.sql
...
BEGIN
	EXECUTE [dbo].[CreateSynonym] @FullyQualifiedName = N'[CEDARS].[dbo].[Claim]';
END
