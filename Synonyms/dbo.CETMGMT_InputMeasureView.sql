RAISERROR ('*** Executing SQL: "...\Synonyms\dbo.CETMGMT_InputMeasureView.sql"', 0, 1) WITH NOWAIT;
GO

/*================================================================================================================
Script:		dbo.CETMGMT_InputMeasureView.sql
...
BEGIN
	EXECUTE [dbo].[CreateSynonym] @FullyQualifiedName = N'[CETMGMT].[dbo].[InputMeasureView]';
END
