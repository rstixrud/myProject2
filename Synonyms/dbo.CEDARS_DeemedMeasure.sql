RAISERROR ('*** Executing SQL: "...\Synonyms\dbo.CEDARS_DeemedMeasure.sql"', 0, 1) WITH NOWAIT;
GO

/*================================================================================================================
Script:		dbo.CEDARS_DeemedMeasure.sql
...
BEGIN
	EXECUTE [dbo].[CreateSynonym] @FullyQualifiedName = N'[CEDARS].[dbo].[DeemedMeasure]';
END
